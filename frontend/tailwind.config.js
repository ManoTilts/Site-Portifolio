...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // CSS vars are stored as space-separated RGB triplets (e.g. "99 102 241"),
        // so we consume them with rgb(... / <alpha-value>) to keep Tailwind's
        // opacity modifiers (bg-primary/20, text-foreground/80, ...) working.
